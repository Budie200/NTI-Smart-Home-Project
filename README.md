...
- [ ] Report /everyone 
- [ ] Proof read report /Khalifa & Abdullah
...
- [ ] LCD: Display temperature, light status, fan status, door status, and system mode. /Abdullah
...
- [X] delay_ms & delay_us
- [ ] Interrupts: Use for a doorbell. /Tamer
